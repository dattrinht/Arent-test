...
public interface IExerciseService
{
    ...
    Task<(IReadOnlyList<ExerciseSummaryDto> Items, int TotalCount)> FetchByProfileAsync(long profileId, DateOnly? byDate, int page, int pageSize, CancellationToken ct = default);
