...
public interface IColumnTaxonomyService
{
    ...
    Task<(IReadOnlyList<ColumnTaxonomySummaryDto> Items, int TotalCount)> FetchByProfileAsync(long profileId, int page, int pageSize, CancellationToken ct = default);
